public class MathAssignment:Assignment
{
    ...
    {
        return $"{base.GetSummary()}{textbookSection} - {problems}";
    }
    ...
    {
        Console.WriteLine($"{GetHomeworkList(_textbookSection, _problems, base.GetSummary().Split(' ')[0], base.GetSummary().Split(' ')[1])} : {base.GetSummary()}");
    }
}