...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Goal Check List: {goalCheckList.GetDescription()}, Status: {goalCheckList.GetStatus()}, Set Points: {goalCheckList.GetSetPoints()}, Set Period: {goalCheckList.GetSetPeriod()}");
    }
}