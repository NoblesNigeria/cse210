...
Added ClearComments() method
Used switch-case (cleaner than many ifs)
Safer file loading

If you want next step, I can:

Turn this into a GUI app (Windows Forms/WPF)
Or build it into a real website comment system (ASP.NET)
Or add user login + likes + replies
